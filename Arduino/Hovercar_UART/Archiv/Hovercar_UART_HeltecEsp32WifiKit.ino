...
#define RCRCV_CH2_PIN 37         //PWM In for RC-Receiver CH2 (Throttle)
#define RCRCV_CH1_PIN 36         //PWM In for RC-Receiver CH1 (Steering)
#define RCRCV_CH6_PIN 35         //PWM In for RC-Receiver CH5 (Drehknopf)
#define RCRCV_CH5_PIN 34         //PWM In for RC-Receiver CH6 (Drehknopf)
#define RCRCV_CH4_PIN 39         //PWM In for RC-Receiver CH4 (3-Way-Switch)
#define RCRCV_CH3_PIN 38        //PWM In for RC-Receiver CH4 (3-Way-Switch)
...
void SerialReport(){
  if (SerialReportNewData)
  {
    switch(SerialReportCounter) {
      case 0: SerialBT.print("a "); SerialBT.println(acclrt_qlf); SerialReportCounter++;  break;
      case 1: SerialBT.print("b "); SerialBT.println(RcRcvCh1_qlf); SerialReportCounter++;  break;
      case 2: SerialBT.print("c "); SerialBT.println(RcRcvCh2_qlf); SerialReportCounter++;  break;
      case 3: SerialBT.print("d "); SerialBT.println(RcRcvCh3_qlf); SerialReportCounter++;  break;
      case 4: SerialBT.print("e "); SerialBT.println(RcRcvCh4_qlf); SerialReportCounter++;  break;
      case 5: SerialBT.print("f "); SerialBT.println(RcRcvCh5_qlf); SerialReportCounter++;  break;
      case 6: SerialBT.print("g "); SerialBT.println(UART_qlf); SerialReportCounter++;  break;
      case 7: SerialBT.print("h "); SerialBT.println(Feedback.batVoltage); SerialReportCounter++;  break;
      case 8: SerialBT.print("i "); SerialBT.println(Feedback.dc_curr); SerialReportCounter++;  break;
      case 9: SerialBT.print("j "); SerialBT.println(Feedback.boardTemp); SerialReportCounter++;  break;
      case 10: SerialBT.print("k "); SerialBT.println(speedAvg_meas); SerialReportCounter++;  break;
      case 11: SerialBT.print("l "); SerialBT.println(RcRcv_SpdCmd); SerialReportCounter++;  break;
      case 12: SerialBT.print("m "); SerialBT.println(RcRcv_StrCmd); SerialReportCounter++;  break;
      case 13: SerialBT.print("n "); SerialBT.println(RcRcv_CtrlMod); SerialReportCounter++;  break;
      case 14: SerialBT.print("o "); SerialBT.println(acclrt_TrqCmd); SerialReportCounter++;  break;
      case 15: SerialBT.print("p "); SerialBT.println(RcRcv_TrqCmd); SerialReportCounter++;  break;
      case 16: SerialBT.print("q "); SerialBT.println(TrqCmd); SerialReportCounter++;  break;
      case 17: SerialBT.print("r "); SerialBT.println(SpdCmd); SerialReportCounter++;  break;
      case 18: SerialBT.print("s "); SerialBT.println(Fahrfreigabe); SerialReportCounter++;  break;
      case 19: SerialBT.print("t "); SerialBT.println(Feedback.pwml); SerialReportCounter++;  break;
      case 20: SerialBT.print("u "); SerialBT.println(Feedback.pwmr); SerialReportCounter++;  break;
      default: SerialReportCounter = 0; SerialReportNewData = 0; break;
    }
  }
}
...
void Task10ms() {
  ...
  //Set Flag for new Data to Report in SerialReport
  SerialReportNewData = 1;
